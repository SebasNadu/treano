...
movies_file_9 = File.read("t_full_movies_9.json")
movies_file_10 = File.read("t_full_movies_10.json")
...
movies_9 = JSON.parse(movies_file_9)
movies_10 = JSON.parse(movies_file_10)
...
tvs_file_9 = File.read("t_full_tvs_9.json")
tvs_file_10 = File.read("t_full_tvs_10.json")
...
tvs_9 = JSON.parse(tvs_file_9)
tvs_10 = JSON.parse(tvs_file_10)
...
puts "50 male users created"
 ...
 movies_seeds(movies_9)
 movies_seeds(movies_10)
